...
function Home() {
    const navigation = useNavigate()
     ...
     const cardStyle =
    "bg-gray-800 rounded-2xl p-6 flex flex-col items-center justify-center shadow-lg hover:bg-gray-700 hover:scale-105 transition cursor-pointer";
    ...
    return (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className={cardStyle} onClick={() => navigation("/AdmitSiteInfo")}>
          ...
          <h2 className="text-xl font-bold mb-2">View Site Info</h2>
          <p className="text-gray-300 text-center">
